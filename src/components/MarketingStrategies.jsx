      ...
      <div className="grid grid-cols-2 gap-20 mt-10">
        {strategies.map((strategy) => (
          <div className="border border-primary p-5 flex flex-col space-y-10 rounded transform hover:scale-105 duration-300">
            <h1 className="mx-20 text-center -mt-11 bg-white border-primary border text-2xl text-secondary font-semibold py-2 rounded">
              {strategy.title}
            </h1>
            <img
              src={strategy.image}
              ...
              className="h-24 w-24 "
            />
            <p className="text-gray-500 text-md hover:text-primary">
